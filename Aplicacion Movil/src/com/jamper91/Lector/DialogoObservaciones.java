...
public class DialogoObservaciones extends DialogFragment {
	...
	private final int REQUEST_CAMERA01 = 1, REQUEST_CAMERA02 = 2,
			REQUEST_CAMERA03 = 3;

	static DialogoObservaciones newInstance(String ob1, String ob2, String ob3,
			String en, String ma) {
	...
	public interface DialogoObservacionesListener {
		public void onDialogAceptarClick(DialogFragment dialog, String ob1,
				String ob2, String ob3);
	}
	...
	public void iniciarlizar() {
		...
		txtOb1 = (EditText) view
				.findViewById(R.id.DialogoObservacion_txtCodObs1);
		txtOb1.setText(obs1);
		txtOb2 = (EditText) view
				.findViewById(R.id.DialogoObservacion_txtCodObs2);
		txtOb2.setText(obs2);
		txtOb3 = (EditText) view
				.findViewById(R.id.DialogoObservacion_txtCodObs3);
		txtOb3.setText(obs3);
		btnOb1 = (ImageView) view
				.findViewById(R.id.DialogoObservacion_btnCamara1);
		btnOb2 = (ImageView) view.findViewById(R.id.DialogoObservacion_btnCamara2);
		btnOb3 = (ImageView) view
				.findViewById(R.id.DialogoObservacion_btnCamara3);
		txtMensaje = (TextView) view
				.findViewById(R.id.DialogoObservacion_txtMensaje);
		btnOb1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				try {
					// Determino si el texto tiene un codigo valido
					String texto = txtOb1.getText().toString();
					...
					txtMensaje.setHint("Código de la observación 1 invalido");
				} catch (Exception e) {
		...
		btnOb2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				try {
					// Determino si el texto tiene un codigo valido
					String texto = txtOb2.getText().toString();
					if (Integer.parseInt(texto) >= 0) {
						Intent i = new Intent(
								"android.media.action.IMAGE_CAPTURE");
						File photo = new File(path + texto+".jpg");
					...
					txtMensaje.setHint("Código de la observación 2 invalido");
				} catch (Exception e) {
		...
		btnOb3.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				try {
					...
					txtMensaje.setHint("Código de la observación 3 invalido");
				} catch (Exception e) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		path = admin.getRutaSalida() + "/Observacion/" + matricula+"_Observacion"+ "_";
		Log.i("path", path);
				...
				public void onClick(View v) {
					...
					if (wantToCloseDialog) {
						mListener.onDialogAceptarClick(
								DialogoObservaciones.this, obs1, obs2, obs3);
						dismiss();
					} else {
